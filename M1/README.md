...
- `backend/main.py` — `--spec-coverage` 的說明字串寫著
  `spec_coverage_*.json (from M1/spec_coverage_analysis.py)`
- `backend/scorecard.py` — docstring 指向 `M1/RECON_NOTES.md`
- `docs/dev/PIPELINE_DESIGN.md` — 多段指令範例用
  `M1/domain_pack_<proj>.json`、`M1/swe1_<proj>_reqs.json`、`M1/spec_coverage_<proj>.json`
- `docs/CHANGELOG.md` — 引用 `M1/PROGRESS.md` 與 `M1/domain_pack_player.json`
