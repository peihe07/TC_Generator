...
const ConfigureModule: React.FC = () => {
  ...
  return (
    <div className="modern-workflow-page modern-configure-page flex flex-col h-full overflow-hidden">
      <div className="flex-1 flex flex-col overflow-hidden" role="tabpanel">
        <div className="modern-configure-header">
          <menu className="modern-configure-tabs" role="tablist">
          ...
          <div className="modern-configure-context" aria-label="Configure summary">
            <span>{tcRows.length} rows</span>
            <span>{estimatedCalls} calls</span>
            <span>${estimatedBudget.toFixed(2)}</span>
          </div>
        </div>

        <div
          className="modern-workflow-panel modern-configure-panel window flex-1 overflow-hidden flex flex-col"
        >
          <div className="window-body modern-configure-body flex-1 overflow-auto">
            {activeTab === 'tab1' && (
              <GroupingTab
                tcRows={tcRows}
                setTcRows={setTcRows}
