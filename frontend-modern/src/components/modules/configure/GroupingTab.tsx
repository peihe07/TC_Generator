...
export const GroupingTab: React.FC<GroupingTabProps> = ({
  ...
  <div className="modern-configure-tab modern-configure-grouping">
    <section className="modern-configure-section modern-configure-intro">
      <div>
      ...
      <div className="modern-configure-actions">
    ...
    <section className="modern-configure-section">
      <div className="modern-configure-section-head">
        <p className="font-bold text-xs uppercase">Group Preview</p>
        <span>{preview?.groups.length ?? 0} groups</span>
      </div>
    ...
    {tcRows.length > 0 && (
      <section className="modern-configure-section">
        ...
        <div
          className="border-sunken modern-configure-manual-table"
          style={{
            maxHeight: 260,
            overflowY: 'auto',
