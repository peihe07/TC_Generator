...
> **加註（下放包 28 §一，T147；原文不刪，R-TM13）** ——
> **本條之二(a) 作廢，見 R-VC27。**
>
> 作廢之事實：`§10.1`／`§10.2` 之 SYS1 `Description` **有文字**，
> 其中 `All four Aux switches (Aux 1 Aux 2, Aux 3, and Aux 4) can be used
> simultaneously` 為實質需求敘述（上繳包 27 §2，A-VC20）。
>
> **⚠ 本加註最該記的一點**（下放包 28 §1.2）：
> 二(a) 之措辭係讀**衍生 PDF** 所得，**從未讀 SYS1 那三格** ——
> 而本條**三、通則**所禁者，正是「以衍生物之判讀充當實測值」。
...
> **加註（下放包 25 §一，T129；原文不改，R-TM13）** ——
> 本項 (e) 之陳述**在列母體上正確且已標母體**，其加註之標的是**讀法**：
>
> 「FROP = PM 之 16 **列**全部落在章 13」與
> 「章 13 之 **leaf** 全部為 PM」**是兩個母體上的兩個命題，前者不蘊含後者**。
>
> **章 13 之 leaf 母體實測為 PM 12 ＋ VS 4**
> —— `VC-062-01`／`062-02`／`063-01`／`063-02` 之 FROP 為 `Vehicle Settings`。
> 該實測**早已載於 `docs/REVISIONS.md` REV-11 之對照表**，非本輪新得；
> 本輪為其**第二次被重新量出來**（REV-14）。
>
> **勿由本條反推 leaf 母體之組成。** 表 A 之編製依 leaf 母體之實測，
> 不沿用任何由本條反推之敘述。
...
> **適用說明（下放包 26 §3.1，T138；原文不改，R-TM13）**
>
> 本條**不得被讀成「凡 `or` 列舉皆拆」**。「互相消耗」之判別，
> 取決於**標的是一次性事件或持續狀態**：
>
> ```
