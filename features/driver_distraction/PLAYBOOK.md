# PLAYBOOK — driver_distraction (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_driver_distraction_Profile.md`
- Kickoff prompt (§5)
...
7. On anything the sources don't state: `[ASSUMPTION A-DRnn]` marker +
...
> 讀 `driver_distractionHMI/PLAYBOOK.md`、`driver_distractionHMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`driver_distractionHMI/feature.yaml`、
...
## 6. Status board — driver_distraction
