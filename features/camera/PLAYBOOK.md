# PLAYBOOK — Camera (FW036 TC Generation)
...
7. On anything the sources don't state: `[ASSUMPTION A-CAnn]` marker +
...
> 讀 `CameraHMI/PLAYBOOK.md`、`CameraHMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`CameraHMI/feature.yaml`、
