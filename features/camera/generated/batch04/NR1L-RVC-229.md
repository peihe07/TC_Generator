...
- **specification_reference**：`VF551_V4_PHDCC27_VF_1753`（來源列 `SYS-RA-VF551_V4-134`）
...
2. The restored display reflects the changes and shows current information
```
