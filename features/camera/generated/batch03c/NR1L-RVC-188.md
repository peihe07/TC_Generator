...
4. PENDING: DR-CAM-q the DTC that the specification defines for Communications_Timeout is not sourced
```
...
3. Set the LVDS signal systemStatus.Communications_Timeout = False
...
3. The LVDS signal systemStatus.Communications_Timeout = False is received by the HU
4. The DTC for Communications_Timeout is no longer present
```
