...
3. PROXI Vehicle_Line_Configuration = 111 (376 (6F Hex))
...
2. Read vehicleUpdate_1.VC_VehLineRVCM and check that it is VEH_376
```
...
2. vehicleUpdate_1.VC_VehLineRVCM = VEH_376 is sent over LVDS
```
