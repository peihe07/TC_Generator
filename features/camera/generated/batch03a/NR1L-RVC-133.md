...
2. Set the LVDS signal systemStatus.ZoomViewRes = SNA
3. Read the HU display and check the state of the Zoom Button
```
...
2. The LVDS signal systemStatus.ZoomViewRes = SNA is received by the HU
3. The Zoom Button is greyed out
```
