# INDEX — pilot02（下放包 CAM-04）

Test Group：`Rear View Camera`（R-CAM4(a)）｜TC ID `NR1L-RVC-001`～`-010`（R-CAM4(b)）
句式對齊 Pei 交付語料，見 `up/20260916_CAM-04.md` §2。
...
| `NR1L-RVC-008` | `SWE-CAM-018` | Display Arbitration | not Ram | 品牌 not Ram | Toro(2261), Fastack (376) | `CFTS092-4781643` | P1 |
| `NR1L-RVC-009` | `SWE-CAM-018` | Display Arbitration | on-point 206 | 邊界 on-point | HDCC27, DT27 | `VF551_V2_PHDCC27_VF_1577` | P1 |
| `NR1L-RVC-010` | `SWE-CAM-018` | Display Arbitration | off-point 205 | 邊界 off-point | HDCC27, DT27 | `VF551_V2_PHDCC27_VF_1577` | P1 |

全部十列之 `Commander (598)` 與 `Regengade (5210)` 皆為 `0`（R-CAM2(b)）。
