...
- Profile: `docs/runtime/profiles/FW036_R1L_SXM_Profile.md`
- Kickoff prompt (§5)
...
7. On anything the sources don't state: `[ASSUMPTION A-SXnn]` marker +
...
> 讀 `features/sxm/PLAYBOOK.md`、`features/sxm/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`features/sxm/feature.yaml`、
