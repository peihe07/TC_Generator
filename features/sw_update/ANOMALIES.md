...
| A-SU5 | T12 之 Description 歸屬以「首見」定之，其游標被文件前置之 `Requirement ID nnn` 清單移動，致 `4907923`／`4907934` 誤歸宿主 `4907907`。正確為 **43 歸需求 / 94 歸章節**，非 45/92 | PENDING | Tier 2（A-SU4 處分 §二 所載之「45」須更正） |
...
## A-SU5 —— T12 之 Description 歸屬受文件前置清單污染 —— PENDING
...
執行層已於 `ANCHOR_POOL.md` §六 更正該二列並標記，語料 v2 依 **43**
建成。**裁決正本未改** —— A-SU4 處分 §二 之「45」待分析層更正。
