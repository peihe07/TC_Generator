...
from gen_batch4 import TCS as H         # noqa: E402
from gen_batch5 import TCS as I         # noqa: E402
from gen_batch6 import TCS as J         # noqa: E402
from gen_batch7 import TCS as K         # noqa: E402
from gen_batch8 import TCS as L         # noqa: E402
from gen_batch9 import TCS as M         # noqa: E402
from gen_batch10 import TCS as N        # noqa: E402
from gen_batch11 import TCS as O        # noqa: E402
from gen_batch12 import TCS as P2       # noqa: E402
from gen_batch13 import TCS as Q        # noqa: E402
from gen_batch14 import TCS as R2       # noqa: E402
from gen_batch15 import TCS as S        # noqa: E402
from gen_batch16 import TCS as T2       # noqa: E402
from gen_batch17 import TCS as U        # noqa: E402
from gen_batch18 import TCS as V        # noqa: E402
from gen_batch19 import TCS as W        # noqa: E402
...
def main():
    tcs = list(P) + list(B) + list(C) + list(D) + list(E) + list(F) + list(G) + list(H) + list(I) + list(J) + list(K) + list(L) + list(M) + list(N) + list(O) + list(P2) + list(Q) + list(R2) + list(S) + list(T2) + list(U) + list(V) + list(W) + list(X)
