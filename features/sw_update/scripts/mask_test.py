...
def main():
    tcs = list(P) + list(B) + list(C) + list(D) + list(E) + list(F) + list(G) + list(H) + list(I) + list(J) + list(K) + list(L) + list(M) + list(N) + list(O) + list(P2) + list(Q) + list(R2) + list(S) + list(T2) + list(U) + list(V) + list(W)
