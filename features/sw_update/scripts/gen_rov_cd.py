...
TCS = [
 ...
 dict(req="SWE1-FOTA-107", spec="CFTS057-4907894", dm=FN, prio="P2",
  ...
  proc=["1. Read the current time shown on the head unit and record it as Time_now",
        "2. Schedule the installation for a time later on the same day and record the selected time as Time_scheduled",
        "3. Read the remaining time shown on the head unit and record it as Time_remaining",
        "4. Check that Time_remaining corresponds to the interval between Time_now and Time_scheduled"],
  er=["1. Time_now is recorded",
      "2. The installation is scheduled and Time_scheduled is recorded",
      "3. Time_remaining is recorded",
      "4. Time_remaining corresponds to the interval between Time_now and Time_scheduled"]),
