...
> ⚠ **二段之一致性問題（上繳包 24 §7.1）**：(a) 段之 `SWE1-FOTA-365`
> **不在 (b) 段之 105 列母群內** —— 其 VC 首句含 `notification`
> （**服務間訊息**，非使用者通知），命中語形判準之偽陰性類
> （上繳包 19 §7.1(甲) 已指認）。
> **(a) 段以人裁為準、(b) 段以語形為準 —— 二段之成員資格用了兩套判準**，
> 故 (a) 非 (b) 之子集。母群應為 **106** 或其定義須改。
> **執行層不自行改母群數**，待分析層裁。
