...
## 用途統計（2026-08-28，**下放包 26 §2.3 清帳後**）
...
| **`Error_Code_List.xlsx`**（9 分頁，T42a 新入） | **陳報中** | — | — | **逐頁陳報，分析層裁** |
| **合計（前三源）** | **58** | **28** | **30** | **0** |

> **`Error_Code_List.xlsx` 之欄位全覽見上繳包 27 §T42b**，
> 其用途標記**本輪一律為陳報**（`未定（本輪陳報）`），**不計入上表之未定數** ——
> R-SU26(b) 之「不得跨輪留存」自其**被裁定之輪次**起算，本輪為其首次陳報。
> **下一輪必裁。**
