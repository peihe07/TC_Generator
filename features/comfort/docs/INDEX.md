...
| 項目 | 值 |
|---|---|
| Phase | 2 覆核完成，**待 Pei 簽署 `DECISIONS.md`**；甲項裁定後可進 Phase 3 |
...
| open anomaly | A-CF02、A-CF04、A-CF06、A-CF07、A-CF08、A-CF09、A-CF11、A-CF12（A-CF10 CLOSED） |
| 真正缺檔 | **2 件**：R1LR ATL-H 機種／螢幕配置（DR #6）、EMEA 市場適用性（DR #7）—— 各擋 6 節與 1 節 |
...
| 檔案 | 內容 |
|---|---|
| `RULINGS.md` | R-C1 ~ R-C11 + R-C4-1 + R-C5-1 逐字（13 條），加執行層落實回報 |
...
| `data/sr24_substantive_applicability.tsv` | 17 節 substantive 之適用性判讀（D-C10 前置） |
