...
- `DUT is connected via ADB with root permission (Dev/Eng build)` — 104 TC
- `Test runner CertProviderAndroidInstrumentalTest.apk is installed` — 24 TC
- `The test runner is verified with adb shell pm list instrumentation | grep melcocertprovider (if missing run adb install -r -t CertProviderServiceManagerTest.apk)` — 22 TC
- `Certificate assets are available under SecurityAssets/oem-certs/cert-provider/` — 18 TC

Instrumentation runners invoked by the test cases:

- `com.mitsubishielectric.ahu.efw.lib.melcocertprovider.libcertproviderservice.test.CertProviderServiceManagerTest#samCertTestNormalFlow` — 18 TC
...
- `com.mitsubishielectric.ahu.efw.lib.melcocertprovider.libcertproviderservice.test.CertProviderServiceManagerTest#ecuCertTestSelfSignedChain` — 1 TC
...
- `$ 10 60` — 4 TC (ECUCert/NR1L-ECUC-006, ECUCert/NR1L-ECUC-011, ECUCert/NR1L-ECUC-016, ECUCert/NR1L-ECUC-017)
- `$ 22 29 65` — 1 TC (ECUCert/NR1L-ECUC-006)
- `$ 22 29 66` — 1 TC (ECUCert/NR1L-ECUC-011)
- `$ 22 F1 B6` — 1 TC (ECUCert/NR1L-ECUC-016)
- `$ 31 01 F0 00` — 2 TC (SwdlSecureLib/NR1L-SWDL-008, SwdlSecureLib/NR1L-SWDL-009)

Diagnostic session access (Pre-Condition verbatim):

- `ADA Active Roles permit ADA+ protected data identifiers` — 7 TC
...
- `$ openssl req -in ecu.crt -noout -verify` — 2 TC
...
### RC — 8 distinct assertions, 18 TC

- `The instrumentation runner reports "OK (1 test)" for samCertTestNormalFlow` — 13 TC
- `The instrumentation runner reports FAILURES!!! with "expected:<OK> but was:<ERR_CERT_REVOKED>"` — 5 TC
...
- `The instrumentation runner reports "OK (1 test)" for ecuCertTestSelfSignedChain` — 1 TC
...
### LOG — 12 distinct assertions, 27 TC

- `The adb logcat -s ECU_CERT_SERVICE_FUNCTION_ID output contains "ECU_INSTALLATION_STATUS value : 2 -> 1"` — 7 TC
- `The adb logcat -d output contains "ERR_CERT_REVOKED"` — 5 TC
...
- `The adb logcat -d output contains "ERR_DEPTH_ZERO_SELF_SIGNED_CERT"` — 1 TC
...
> 4 further LOG assertions follow the same shape; the workbook is authoritative.

### FILE — 48 distinct assertions, 61 TC

- `The adb shell ls -l /data/misc/ecuidentity output lists "ecu.cacert" and "ecu.crt"` — 6 TC
- `The adb shell od -t x1 /mnt/vendor/oemkeys/installstate output shows the installstate value 2` — 6 TC
- `The adb shell ls -la /vendor/odm/etc/cert_store/ output lists "dcl.json"` — 5 TC
- `The adb shell od -t x1 /mnt/vendor/oemkeys/installstate output shows the installstate value 3` — 5 TC
- `The adb shell ls -la /vendor/odm/etc/cert_store/ output lists "cfgs/", "oem_cert_tree/", "ecu_chain/" and "dcl.json"` — 4 TC
- `The adb shell ls -la /vendor/odm/etc/cert_store/cfgs/ output lists "2nd_party.cfg", "sam.cfg" and "ecu.cfg"` — 4 TC
...
> 40 further FILE assertions follow the same shape; the workbook is authoritative.
...
### HOST — 15 distinct assertions, 19 TC
...
- `The openssl command prints "verify OK" on stdout` — 2 TC
...
- `dauth` — 16 TC
- `ECU_CERT_SERVICE_FUNCTION_ID` — 7 TC
...
- `/data/misc/ecuidentity/` — 13 TC
- `/data/vendor/dauth` — 11 TC
- `/vendor/odm/etc/cert_store/dcl.json` — 10 TC
- `/vendor/odm/etc/cert_store/` — 9 TC
- `/data/misc/ecuidentity` — 8 TC
- `/vendor/odm/etc/cert_store` — 6 TC
- `/mnt/vendor/oemkeys` — 5 TC
- `/data/vendor/dauth/seqId` — 4 TC
- `/data/vendor/dauth/ts` — 4 TC
- `/vendor/odm/etc/cert_store/cfgs/` — 4 TC
- `/vendor/odm/etc/cert_store/ecu_chain/` — 4 TC
- `/vendor/odm/etc/cert_store/oem_cert_tree/` — 4 TC
...
| 2 | `$ adb shell am instrument -w -e class com.mitsubishielectric.ahu.efw.lib.melcocertprovider.libcertproviderservice.test.CertProviderServiceManagerTest#samCertTestNormalFlow com.mitsubishielectric.ahu.efw.lib.melcocertprovider.libcertproviderservice.test/androidx.test.runner.AndroidJUnitRunner` | CertProvider/NR1L-CP-004, CertProvider/NR1L-CP-006, CertProvider/NR1L-CP-008, CertProvider/NR1L-CP-010, CertProvider/NR1L-CP-011, CertProvider/NR1L-CP-012 …(+2) |
| 3 | `$ adb shell od -t x1 /mnt/vendor/oemkeys/installstate` | KeyInstall/NR1L-KI-001, KeyInstall/NR1L-KI-002, KeyInstall/NR1L-KI-003, KeyInstall/NR1L-KI-004, KeyInstall/NR1L-KI-005, KeyInstall/NR1L-KI-006 …(+11) |
| 4 | `$ adb logcat -s dauth` | SAM/NR1L-SAM-006, SAM/NR1L-SAM-007, SAM/NR1L-SAM-008, SAM/NR1L-SAM-009, SAM/NR1L-SAM-013, SAM/NR1L-SAM-019 …(+10) |
| 5 | `$ openssl verify -verbose -CAfile RootCert.pem -untrusted L1.pem -untrusted L2.pem -untrusted L3.pem SAMcert.pem` | CertProvider/NR1L-CP-001, CertProvider/NR1L-CP-002, CertProvider/NR1L-CP-004, CertProvider/NR1L-CP-005, CertProvider/NR1L-CP-006, CertProvider/NR1L-CP-007 …(+6) |
| 6 | `$ adb shell ls -l /data/vendor/dauth` | SAM/NR1L-SAM-003, SAM/NR1L-SAM-004, SAM/NR1L-SAM-005, SAM/NR1L-SAM-012, SAM/NR1L-SAM-014, SAM/NR1L-SAM-015 …(+2) |
| 7 | `$ adb shell ls -la /vendor/odm/etc/cert_store/` | CertProvider/NR1L-CP-008, CertProvider/NR1L-CP-010, CertProvider/NR1L-CP-011, CertProvider/NR1L-CP-012, CertProvider/NR1L-CP-013, CertProvider/NR1L-CP-020 …(+3) |
| 8 | `$ adb logcat -c` | CertProvider/NR1L-CP-003, CertProvider/NR1L-CP-008, CertProvider/NR1L-CP-010, CertProvider/NR1L-CP-011, CertProvider/NR1L-CP-012, CertProvider/NR1L-CP-013 …(+2) |
| 9 | `$ adb shell ls -l /data/misc/ecuidentity` | ECUCert/NR1L-ECUC-001, ECUCert/NR1L-ECUC-002, ECUCert/NR1L-ECUC-003, ECUCert/NR1L-ECUC-004, ECUCert/NR1L-ECUC-007, ECUCert/NR1L-ECUC-008 …(+2) |
| 10 | `$ adb logcat -s ECU_CERT_SERVICE_FUNCTION_ID` | ECUCert/NR1L-ECUC-001, ECUCert/NR1L-ECUC-002, ECUCert/NR1L-ECUC-003, ECUCert/NR1L-ECUC-004, ECUCert/NR1L-ECUC-007, ECUCert/NR1L-ECUC-008 …(+1) |
| 11 | `$ adb push ecu.crt /data/misc/ecuidentity/` | ECUCert/NR1L-ECUC-002, ECUCert/NR1L-ECUC-003, ECUCert/NR1L-ECUC-004, ECUCert/NR1L-ECUC-007, ECUCert/NR1L-ECUC-008, ECUCert/NR1L-ECUC-010 …(+1) |
| 12 | `$ <command provided by RD (X-e)>` | CertProvider/NR1L-CP-005, CertProvider/NR1L-CP-007, CertProvider/NR1L-CP-014, CertProvider/NR1L-CP-021, NR1L-CP-027, NR1L-CP-028 |
| 13 | `$ adb logcat -d | grep -i "CertProvider"` | CertProvider/NR1L-CP-003, CertProvider/NR1L-CP-008, CertProvider/NR1L-CP-010, CertProvider/NR1L-CP-011, CertProvider/NR1L-CP-012, CertProvider/NR1L-CP-013 |
| 14 | `$ adb push ecu.cacert /data/misc/ecuidentity/` | ECUCert/NR1L-ECUC-002, ECUCert/NR1L-ECUC-003, ECUCert/NR1L-ECUC-004, ECUCert/NR1L-ECUC-007, ECUCert/NR1L-ECUC-008, ECUCert/NR1L-ECUC-010 |
| 15 | `$ adb reboot` | ECUCert/NR1L-ECUC-002, ECUCert/NR1L-ECUC-003, ECUCert/NR1L-ECUC-004, ECUCert/NR1L-ECUC-007, ECUCert/NR1L-ECUC-008, ECUCert/NR1L-ECUC-010 |
| 16 | `$ adb shell ls -l /vendor/odm/etc/cert_store` | CertProvider/NR1L-CP-008, CertProvider/NR1L-CP-015, CertProvider/NR1L-CP-020, CertProvider/NR1L-CP-021, NR1L-CP-024, NR1L-CP-025 |
| 17 | `$ openssl x509 -in leaf.crt -text` | CertProvider/NR1L-CP-004, CertProvider/NR1L-CP-005, CertProvider/NR1L-CP-006, CertProvider/NR1L-CP-007, NR1L-CP-027, NR1L-CP-028 |
| 18 | `$ adb push dcl_baseline.json /vendor/odm/etc/cert_store/dcl.json` | CertProvider/NR1L-CP-008, CertProvider/NR1L-CP-010, CertProvider/NR1L-CP-011, CertProvider/NR1L-CP-012, CertProvider/NR1L-CP-013 |
| 19 | `$ adb root && adb remount` | CertProvider/NR1L-CP-008, CertProvider/NR1L-CP-010, CertProvider/NR1L-CP-011, CertProvider/NR1L-CP-012, CertProvider/NR1L-CP-013 |
| 20 | `$ 10 60` | ECUCert/NR1L-ECUC-006, ECUCert/NR1L-ECUC-011, ECUCert/NR1L-ECUC-016, ECUCert/NR1L-ECUC-017 |
| 21 | `$ <command provided by RD (X-l)>` | SwdlSecureLib/NR1L-SWDL-004, SwdlSecureLib/NR1L-SWDL-005, SwdlSecureLib/NR1L-SWDL-006, SwdlSecureLib/NR1L-SWDL-007 |
...
| 23 | `$ adb shell cat /data/vendor/dauth/seqId` | SAM/NR1L-SAM-027, SAM/NR1L-SAM-030, SAM/NR1L-SAM-031 |
| 24 | `$ adb shell cat /data/vendor/dauth/ts` | SAM/NR1L-SAM-016, SAM/NR1L-SAM-017 |
| 25 | `$ adb shell ls -l /mnt/vendor/oemkeys` | KeyInstall/NR1L-KI-003, KeyInstall/NR1L-KI-007, KeyInstall/NR1L-KI-012, KeyInstall/NR1L-KI-014 |
| 26 | `$ adb shell ls -la /vendor/odm/etc/cert_store/cfgs/` | CertProvider/NR1L-CP-020, CertProvider/NR1L-CP-021, NR1L-CP-024, NR1L-CP-025 |
| 27 | `$ adb shell ls -la /vendor/odm/etc/cert_store/ecu_chain/` | CertProvider/NR1L-CP-020, CertProvider/NR1L-CP-021, NR1L-CP-024, NR1L-CP-025 |
| 28 | `$ adb shell ls -la /vendor/odm/etc/cert_store/oem_cert_tree/` | CertProvider/NR1L-CP-020, CertProvider/NR1L-CP-021, NR1L-CP-024, NR1L-CP-025 |
| 29 | `$ openssl x509 -in SAMcert.pem -text` | SAM/NR1L-SAM-006, SAM/NR1L-SAM-010, SAM/NR1L-SAM-011, SAM/NR1L-SAM-012 |
| 30 | `$ <command provided by RD (X-f-2)>` | KeyInstall/NR1L-KI-018, KeyInstall/NR1L-KI-019, KeyInstall/NR1L-KI-022 |
| 31 | `$ <command provided by RD (X-k)>` | ECUCert/NR1L-ECUC-005, ECUCert/NR1L-ECUC-012, ECUCert/NR1L-ECUC-018 |
| 32 | `$ adb shell cat /data/vendor/dauth/vc` | SAM/NR1L-SAM-019, SAM/NR1L-SAM-020, SAM/NR1L-SAM-021 |
| 33 | `$ ./logdecrypt_Ver2.sh HUssss_YYYYMMDD_HHMMSS_XXXX.enc HUssss_YYYYMMDD_HHMMSS_XXXX_enckey.enc` | libLogEncrypt/NR1L-LOGENC-009 |
| 34 | `$ 31 01 F0 00` | SwdlSecureLib/NR1L-SWDL-008, SwdlSecureLib/NR1L-SWDL-009 |
| 35 | `$ <command provided by RD (X-n)>` | SAM/NR1L-SAM-024, SAM/NR1L-SAM-025 |
| 36 | `$ <command provided by STLA (X-d)>` | ECUCert/NR1L-ECUC-001, ECUCert/NR1L-ECUC-017 |
| 37 | `$ adb logcat -s Logdog` | CertProvider/NR1L-CP-022, CertProvider/NR1L-CP-023 |
| 38 | `$ adb logcat -s MelcoCertProviderTest` | CertProvider/NR1L-CP-001, CertProvider/NR1L-CP-002 |
| 39 | `$ adb pull /data/misc/ecuidentity/ecu.crt` | ECUCert/NR1L-ECUC-006, ECUCert/NR1L-ECUC-013 |
| 40 | `$ adb push dcl_revoked.json /vendor/odm/etc/cert_store/dcl.json` | CertProvider/NR1L-CP-008, CertProvider/NR1L-CP-010 |
...
| 42 | `$ adb shell ls -l /data/vendor/logdog` | libLogEncrypt/NR1L-LOGENC-007, libLogEncrypt/NR1L-LOGENC-008 |
| 43 | `$ adb shell od -t x1 /mnt/vendor/oemkeys/ecu/state/ecucertstatus` | ECUCert/NR1L-ECUC-009, ECUCert/NR1L-ECUC-010 |
| 44 | `$ adb shell procrank` | KeyInstall/NR1L-KI-025, NR1L-CP-026 |
| 45 | `$ openssl req -in ecu.crt -noout -verify` | ECUCert/NR1L-ECUC-006, ECUCert/NR1L-ECUC-012 |
| 46 | `Send CAN: BCM_FD_10.CmdIgnSts = 4 (RUN)` | SAM/NR1L-SAM-022, SAM/NR1L-SAM-030 |
| 47 | `Send CAN: STATUS_BH_BCM2.CmdIgnSts = 4 (RUN)` | SAM/NR1L-SAM-023, SAM/NR1L-SAM-031 |
| 48 | `$ 22 29 65` | ECUCert/NR1L-ECUC-006 |
| 49 | `$ 22 29 66` | ECUCert/NR1L-ECUC-011 |
| 50 | `$ 22 F1 B6` | ECUCert/NR1L-ECUC-016 |
| 51 | `$ <command provided by RD (X-j)>` | KeyInstall/NR1L-KI-015 |
| 52 | `$ <command provided by RD (X-m)>` | libLogEncrypt/NR1L-LOGENC-009 |
| 53 | `$ <command provided by STLA (X-c)>` | NR1L-CP-025 |
| 54 | `$ adb logcat -s KeyInstall` | KeyInstall/NR1L-KI-019 |
| 55 | `$ adb logcat -s avc` | KeyInstall/NR1L-KI-022 |
| 56 | `$ adb logcat -s logdog` | SAM/NR1L-SAM-005 |
| 57 | `$ adb push dcl_revoked_l0.json /vendor/odm/etc/cert_store/dcl.json` | CertProvider/NR1L-CP-013 |
| 58 | `$ adb push dcl_revoked_l1.json /vendor/odm/etc/cert_store/dcl.json` | CertProvider/NR1L-CP-012 |
| 59 | `$ adb push dcl_revoked_l2.json /vendor/odm/etc/cert_store/dcl.json` | CertProvider/NR1L-CP-011 |
| 60 | `$ adb shell am instrument -w -e class com.mitsubishielectric.ahu.efw.lib.melcocertprovider.libcertproviderservice.test.CertProviderServiceManagerTest#ecuCertTestSelfSignedChain com.mitsubishielectric.ahu.efw.lib.melcocertprovider.libcertproviderservice.test/androidx.test.runner.AndroidJUnitRunner` | CertProvider/NR1L-CP-003 |
...
| 64 | `$ adb shell cat /sys/devices/soc0/serial_number` | SAM/NR1L-SAM-008 |
| 65 | `$ adb shell df /mnt/vendor/oemkeys` | KeyInstall/NR1L-KI-025 |
| 66 | `$ adb shell getsslog` | libLogEncrypt/NR1L-LOGENC-007 |
| 67 | `$ adb shell ls -Z /data/vendor/dauth` | SAM/NR1L-SAM-032 |
| 68 | `$ adb shell od -t x1 /mnt/vendor/oemkeys/<status file>` | KeyInstall/NR1L-KI-004 |
| 69 | `$ adb shell ps -A` | SAM/NR1L-SAM-002 |
| 70 | `$ openssl verify -verbose -CAfile RootCert.pem -untrusted L1.pem -untrusted L2.pem -untrusted L3.pem -untrusted CRL.pem SAMcert.pem` | CertProvider/NR1L-CP-009 |
| 71 | `$ openssl x509 -in ecu.crt -noout -text` | ECUCert/NR1L-ECUC-013 |

## 4. Assets still to be provided

From `placeholder_by_token.tsv`; the placeholders inside the workbook carry the same code. See `asset_request.md` for who to ask and the urgency order. The 48 rows containing placeholders are shaded light orange (FCE4D6) in the delivery workbooks (`placeholder_rows.tsv` lists them).
...
> Not a channel: 41 test cases carry a placeholder command line (`<command provided by …>`, written as a `$` step) and cannot be automated until the asset arrives; 48 test cases carry a placeholder in any field and are the shaded rows — see section 4.
