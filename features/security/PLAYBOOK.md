# PLAYBOOK — Security (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_Security_Profile.md`
- Kickoff prompt (§5)
...
7. On anything the sources don't state: `[ASSUMPTION A-SEnn]` marker +
...
> 讀 `SecurityHMI/PLAYBOOK.md`、`SecurityHMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`SecurityHMI/feature.yaml`、
