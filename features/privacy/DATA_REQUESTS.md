...
| 2 | `Audio_Output_Management_-_LTM_ETM_Amplified_Audio_System_VF651_V6_R2.docx` | ⚠️ **已出現在來源目錄**（`10_Reviewing/00_TestCase/ASW-R2/Privacy Mode/`，184,808 bytes，2025-05-22），**未複製入 `inputs/`** —— R-PV01(c) 未簽署，canon §6 特化停手條件禁止自裁變體取捨 | -007 / -008 / -010（AMP is present）；-006 / -009 反向對照 | AMP-present 情境批 | A-PV02 | **Medium —— 待 R-PV01(c)；一簽即可入 `inputs/`** |
| 3 | `…with_Internal_ANC_VF651_V9_R3.docx` / `…with_ANC_VF651_V11_R3.docx` | 未入 `inputs/` | 僅在 ANC 配置納入範圍時 | — | A-PV02 | Low |
