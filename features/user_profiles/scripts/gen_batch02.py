...
TCS = {
    ...
    "SWE1-HMI-PROF-135": dict(
        ...
        reasoning=(
            ...
            "**判級依據（21 輪 K-1 之連帶，36 輪補正）**：依 **canon §10.2 之 "
            "safety** 直接成立 P0 —— R-U5 之核心五類為**例示非窮盡**"
            "（D-UP16-01 附二），**不需迂迴經 tie-break**。"
            "（原記「R-U5 之 rubric 無安全帶，依 D-UP16-01 就近判」——"
            "該說法於 21 輪已作廢，當時改了 `089`／`116` 而**漏了本條**。）"),
