...
TCS = {
    ...
    "SWE1-HMI-PROF-126-02": dict(
        ...
        reasoning=(
            ...
            "為什麼這樣切：按下已變灰之按鈕之提示屬 126-03，本條只驗其變灰。"
            "**依 description 生成；標題與描述錯位，見 A-UP11。**"),
    ...
    "SWE1-HMI-PROF-132-01": dict(
        ...
        er=steps("The Valet Profile icon does not open a deactivation flow",
                 ...
                 "Profiles” tab",
                 "Valet Mode is still active and any popup that would allow "
                 "an exit is blocked"),
    ...
    "SWE1-HMI-PROF-134": dict(
        ...
        remarks="條文之「the Exit Valet Mode process **above**」其指涉對象"
                ...
                "複位後為 12.3.1（同一 PIN 退出）與 12.6（停用詢問），故併列該二節。"
                "見上繳 19 §4",
        reasoning=(
