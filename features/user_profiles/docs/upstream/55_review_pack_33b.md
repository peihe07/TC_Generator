...
- 本檔 **16 條**；另半在 `55_review_pack_33a.md`
- 由 `scripts/build_review_pack.py` 產生，不經人手轉錄
- **本檔取代 `47_review_pack_33b.md`**（AA-1，44 包）——該檔無語料指紋，`--verify` 一律判過期
...
| `NR1L-UserProfiles-175` | `cb5144cde075` |
| `NR1L-UserProfiles-176` | `af974cd18bb6` |
| `NR1L-UserProfiles-177` | `0deeabcd3e5c` |
| `NR1L-UserProfiles-178` | `3f70a0f50f36` |
| `NR1L-UserProfiles-179` | `d380b18fb84b` |
...
| 欄 | 值 |
|---|---|
| test_item（兩段） | Highlight moves to the newly chosen avatar<br>(Verifies that the highlight moves to the newly chosen avatar) |
