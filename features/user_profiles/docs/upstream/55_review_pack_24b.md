...
- 本檔 **11 條**；另半在 `55_review_pack_24a.md`
- 由 `scripts/build_review_pack.py` 產生，不經人手轉錄
- **本檔取代 `48_review_pack_24b.md`**（AA-1，44 包）——該檔無語料指紋，`--verify` 一律判過期
...
| `NR1L-UserProfiles-155` | `3fdc86e61360` |
...
| 欄 | 值 |
|---|---|
| test_item（兩段） | Switch Users opens the All Profiles tab<br>(Verifies that Switch Users opens the All Profiles tab of the Profile section) |
