...
> **⚠ 本檔已於 45 輪重出取代 → `45_review_pack_24b.md`。**
> 其產生後語料有變動 **2 條**（`148`／`154`，AB-1 之修正）——
...
- **本檔取代 `40_review_pack_24b.md`**（AA-1，44 包）——該檔無語料指紋，`--verify` 一律判過期
...
| `NR1L-UserProfiles-148` | `dba357deee2e` |
...
| `NR1L-UserProfiles-154` | `34a1a6828e79` |
