# PLAYBOOK — Audio Management (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_Audio_Management_Profile.md`
- Kickoff prompt (§5)
...
> 讀 `audio_mgmt/PLAYBOOK.md`、`audio_mgmt/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`audio_mgmt/feature.yaml`、
...
## 6. Status board — Audio Management
