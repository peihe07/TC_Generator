...
## 五、池外錨登記表 —— **rev 2：A-AM10 撤回，包 16 §一 正確**

> **更正（A-AM13）**：本節原主張 264 為池外並質疑包 16 §一，係執行層
> 池抽取缺陷所致（`fullmatch` 漏多值格）。以展開池 v2 複驗，
> **4867598 與 4867604 皆在池內**，264 與 266 為池內葉，
> B4 池外集合為 **4 葉：306、307、308、311**。
> **A-AM10 撤回**，包 16 §一 之判定成立。
> 交付欄未變（`31d8c8e7…`），工作簿未重寫。以下原表不再具效力。
