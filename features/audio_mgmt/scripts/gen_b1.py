...
tc("SWE1_AMM_132",
   ...
   ["Play an FM station and start a \"SEEK\" operation",
    ...
    "Verify the source transition starts only after the seek operation has ended"],
...
tc("SWE1_AMM_132",
   ...
   ["Play an FM station and start a \"SCAN\" operation",
    ...
    "Verify the scan operation is cancelled before the transition"],
...
tc("SWE1_AMM_133",
   ...
   ["Play an Entertainment source at a fixed volume",
    ...
    "Verify the measured ramp-down time is within the specified range"],
...
tc("SWE1_AMM_134",
   ...
   ["Play Entertainment source A",
    ...
    "Verify source B is the active Entertainment source"],
...
tc("SWE1_AMM_135",
   ...
   ["Play Entertainment source A",
    ...
    "Verify the measured mute interval covers the ramp-down, the amplifier mute and the ramp-up"],
   ["Entertainment source A plays",
    "The selection of source B is accepted",
...
tc("SWE1_AMM_136",
   ...
   ["Play Entertainment source A",
    "Select Entertainment source B",
    "Monitor $HUModeStatus$ on the vehicle bus",
    "Verify $HUModeStatus$ reports source B immediately after the ramp-down completes"],
   ["Entertainment source A plays",
    "The selection of source B is accepted",
...
tc("SWE1_AMM_137",
   ...
   ["Play Entertainment source A at volume level 20",
    ...
    "Verify the ramp-up time is within the specified range and the recalled volume is restored"],
...
tc("SWE1_AMM_142",
   ...
   ["Play a USB media track",
    ...
    "Verify the USB media source was paused before it was deactivated"],
...
tc("SWE1_AMM_143",
   ...
   ["Play an FM station and start a \"PTY SEEK\" operation",
    "Select a different Entertainment source",
    "Verify the PTY seek is cancelled before the Entertainment source is deactivated"],
...
tc("SWE1_AMM_144",
   ...
   ["Play an Entertainment source at a fixed volume",
    ...
    "Verify the Entertainment ramp-down completes within the specified range"],
   ["Entertainment audio plays at the set volume",
...
tc("SWE1_AMM_154",
   ...
   ["Play no audio source",
    ...
    "Verify the Information audio reaches the volume level defined in the Information Source Handling Table",
    "Verify the ramp is applied to the channels listed in the \"Applied Channels\" column"],
...
tc("SWE1_AMM_159",
   ...
   ["Trigger a Navigation guidance prompt",
    ...
    "Verify the Information audio reaches volume level 0 within the specified range"],
...
tc("SWE1_AMM_169",
   ...
   ["Play no audio source",
    ...
    "Verify the signal source ramps up on the indicated channels"],
   ["No audio source is active",
...
tc("SWE1_AMM_201",
   ...
   ["Verify no audio source is active",
    "Activate an Entertainment source",
    "Measure the ramp-up time",
    "Verify the measured ramp-up time is within the specified range"],
   ["No audio source is active",
...
tc("SWE1_AMM_203",
   ...
   ["Play an Entertainment source",
    ...
    "Verify the ramp-down completes within the specified range"],
...
tc("SWE1_AMM_206",
   ...
   ["Play Entertainment source A",
    "Select Entertainment source B",
    "Verify source A ramps down before source B becomes audible"],
   ["Entertainment source A plays",
    "The selection of source B is accepted",
...
tc("SWE1_AMM_208",
   ...
   ["Play Entertainment source A",
    "Select Entertainment source B",
    "Monitor the output channel for the Entertainment source",
    "Measure the interval between the end of source A and the first audio of source B",
    "Verify the output is muted throughout the delay and source B starts only after it expires"],
   ["Entertainment source A plays",
    "The selection of source B is accepted",
...
tc("SWE1_AMM_209",
   ...
   ["Play Entertainment source A",
    ...
    "Verify source B ramps up within the specified range and playback starts after the ramp"],
   ["Entertainment source A plays",
    "The selection of source B is accepted",
...
tc("SWE1_AMM_212",
   ...
   ["Play no audio source",
    "Activate an Entertainment source",
    "Monitor $HUModeStatus$ and $VolumeENT$ on the vehicle bus",
    "Verify $HUModeStatus$ reports the active Entertainment source",
    "Verify $VolumeENT$ carries the current Entertainment volume",
    "Verify the Entertainment audio stream reaches the amplifier"],
   ["No audio source is active",
    "The Entertainment source starts",
...
tc("SWE1_AMM_213",
   ...
   ["Tune a DAB station with traffic announcements enabled",
    ...
    "Monitor $HUModeStatus$ on the vehicle bus",
    "Verify $HUModeStatus$ reports \"DAB_Selected\"",
    "Verify the announcement audio reaches the amplifier"],
...
tc("SWE1_AMM_213",
   ...
   ["Tune an FM station with traffic announcements enabled",
    "Trigger a traffic announcement",
    "Monitor $HUModeStatus$ on the vehicle bus",
    "Verify $HUModeStatus$ reports \"FM_Selected\""],
...
tc("SWE1_AMM_216",
   ...
   ["Play an Entertainment source",
    "Deactivate the Entertainment source",
    "Monitor $HUModeStatus$ on the vehicle bus",
    "Verify $HUModeStatus$ reports \"HU_Off\""],
   ["Entertainment audio plays",
    "The deactivation is accepted",
    "$HUModeStatus$ is transmitted",
...
tc("SWE1_AMM_223",
   ...
   ["Play an Entertainment source",
    ...
    "Verify the Information audio ramps down and Entertainment ramps up on the passenger and driver channels"],
   ["Entertainment audio plays",
...
tc("SWE1_AMM_224",
   ...
   ["Trigger a Navigation guidance prompt",
    ...
    "Verify the Navigation audio ramps down on all channels before the Voice Recognition audio starts"],
   ["The Navigation guidance prompt plays",
...
tc("SWE1_AMM_225",
   ...
   ["Play an Entertainment source",
    ...
    "End the guidance prompt",
    "Read the stored Information volume level and record it",
    "Verify the Information audio ramps down to volume level 0 and Entertainment ramps up"],
   ["Entertainment audio plays",
...
for sid, label, direction, anchor_extra in [
    ...
    tc(sid,
       ...
       [trigger,
        ...
        "Verify the measured duration is not shorter than the lower bound"],
    ...
    tc(sid,
       ...
       [trigger,
        f"Measure the {label.lower()} ramp-{direction} duration",
        "Verify the measured duration does not exceed the upper bound"],
       [f"The {label} source ramp-{direction} starts",
        f"The ramp-{direction} duration is measured",
...
tc("SWE1_AMM_123",
   ...
   ["Trigger a signal source with priority S2",
    ...
    "Verify only the S1 signal source is active"],
...
tc("SWE1_AMM_124",
   ...
   ["Play an Entertainment source",
    ...
    "Verify the higher priority source becomes active and the Entertainment source is overridden"],
   ["Entertainment audio plays",
...
tc("SWE1_AMM_129",
   ...
   ["Trigger a confirmation tone",
    ...
    "Verify the Entertainment source starts only after the tone has completed"],
...
tc("SWE1_AMM_130",
   ...
   ["Trigger a high priority audio source",
    ...
    "Verify the lower priority request does not play",
    "End the high priority source",
    "Verify the queued request plays once it has sufficient priority"],
...
tc("SWE1_AMM_139",
   ...
   ["Trigger a high priority audio source",
    ...
    "End the high priority source",
    "Verify the higher of the two queued requests plays first",
    "Verify the remaining queued request plays after it"],
   ["The high priority source is active",
...
tc("SWE1_AMM_166",
   ...
   ["Trigger a high priority audio source and a lower priority audio source",
    "End the high priority source",
    "Verify the next highest priority source becomes active"],
...
tc("SWE1_AMM_167",
   ...
   ["Trigger two audio sources that are allowed to play together",
    ...
    "Verify the remaining sources are re-mixed on the configured channels"],
...
tc("SWE1_AMM_189",
   ...
   ["Play an Entertainment source and a higher priority audio source",
    ...
    "Verify the sources below the TBM mute in priority are muted or paused",
    "Verify the sources above the TBM mute in priority keep playing"],
   ["Both sources play",
...
tc("SWE1_AMM_198",
   ...
   ["Play an Entertainment source",
    ...
    "Verify the audio sources below \"TBM Mute Request\" in priority are muted"],
   ["Entertainment audio plays",
...
tc("SWE1_AMM_199",
   ...
   ["Set $TBM_FD_1.SOSCallType$ = 2 (Manual_SOS_call) while an Entertainment source plays",
    ...
    "Verify the audio sources below \"TBM Mute Request\" in priority are unmuted"],
   ["The audio sources below \"TBM Mute Request\" in priority are muted",
...
tc("SWE1_AMM_211",
   ...
   ["Verify no audio source is active",
    ...
    "Verify the activation follows the configured routing table"],
   ["No audio source is active",
...
tc("SWE1_AMM_215",
   ...
   ["Play an audio source",
    ...
    "Verify both sources play together as the routing table configures"],
...
tc("SWE1_AMM_226",
   ...
   ["Trigger a Navigation guidance prompt",
    ...
    "Verify the Navigation audio is cancelled",
    "Verify the Voice Recognition audio becomes active"],
   ["The Navigation guidance prompt plays",
...
tc("SWE1_AMM_227",
   ...
   ["Trigger a traffic announcement",
    ...
    "Verify the traffic announcement audio is cancelled",
    "Verify the hands-free call audio becomes active"],
...
tc("SWE1_AMM_138",
   ...
   ["Play Entertainment source A",
    ...
    "Verify the three phases occur in the order the transition figure gives"],
   ["Entertainment source A plays",
    "The selection of source B is accepted",
...
tc("SWE1_AMM_156",
   ...
   ["Play an Entertainment source",
    ...
    "Verify the sequence matches the Entertainment to Information transition figure"],
   ["Entertainment audio plays",
    "The Navigation guidance prompt starts",
...
tc("SWE1_AMM_157",
   ...
   ["Trigger a Navigation guidance prompt",
    ...
    "Verify the sequence matches the Information 1 to Information 2 transition figure"],
   ["The Navigation guidance prompt plays",
    "The Voice Recognition session starts",
...
tc("SWE1_AMM_200",
   ...
   ["Verify no audio source is active",
    ...
    "Verify the sequence matches the non-arbitrated source transition diagram"],
   ["No audio source is active",
    "The Entertainment source starts",
...
tc("SWE1_AMM_205",
   ...
   ["Play Entertainment source A",
    ...
    "Record the transition sequence",
    "Verify the sequence matches the non-arbitrated Entertainment to Entertainment diagram"],
   ["Entertainment source A plays",
...
tc("SWE1_AMM_240",
   ...
   ["Play an Entertainment source",
    ...
    "Verify the sequence matches the arbitrated source transition diagram"],
   ["Entertainment audio plays",
...
tc("SWE1_AMM_241",
   ...
   ["Trigger a Navigation guidance prompt",
    ...
    "Record the arbitration and routing behaviour",
    "Verify the sequence matches the arbitrated Information source transition diagram"],
   ["The Navigation guidance prompt plays",
