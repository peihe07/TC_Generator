# lint036 報告：FM-WI-FSM-036-A01 STLA 測試用例規範與結果_SWQT STLA Test Case Specification & Result_SWQT_VehicleSetupManagementR1Low_20260902.xlsx

- 來源：`features/vsm_v42/delivered/FM-WI-FSM-036-A01 STLA 測試用例規範與結果_SWQT STLA Test Case Specification & Result_SWQT_VehicleSetupManagementR1Low_20260902.xlsx`（唯讀）
- 資料列數：17
...
| M | 空欄三態 | 0 | 0 | 每列每欄 | 已校準 |
| N | 行尾多餘句號 | 0 | 0 | 每行 | 已校準 |
| P | 訊號寫法不合 R-1 v2 | 60 | 15 | 每次命中 | 已校準（SWC 0708：195 —— proc 11／er 184，見上繳 09） |
...
**總計：行計 89**（列計不加總——同一列可觸發多項檢查）

## 明細

### P — 訊號寫法不合 R-1 v2（行計 60／列計 15）
...
| 12 | NR1L-VSM42-003 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$' | 1. The signal value $TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$ = 1 (On)  |
...
| 13 | NR1L-VSM42-004 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$' | 1. Send the signal $IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$ = 1 (On) |
...
| 13 | NR1L-VSM42-004 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$' | 3. The signal value $IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$ = 1 (On) is receive |
...
| 14 | NR1L-VSM42-005 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$' | 1. The signal value $TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$ = 1 (On)  |
...
| 15 | NR1L-VSM42-006 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$' | 1. The signal value $TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$ = 1 (On)  |
...
| 16 | NR1L-VSM42-007 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$' | 1. The signal value $TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$ = 1 (On)  |
...
| 17 | NR1L-VSM42-008 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$' | 1. The signal value $TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$ = 1 (On)  |
...
| 18 | NR1L-VSM42-009 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$' | 1. The signal value $TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$ = 1 (On)  |
...
| 19 | NR1L-VSM42-010 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$' | 1. The signal value $TELEMATIC_VEHICLE_SETUP2.EPB_MaintenanceMode_Req$ = 1 (On)  |
...
| 24 | NR1L-VSM42-015 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$' | 1. Send the signal $IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$ = 1 (On) |
...
| 24 | NR1L-VSM42-015 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$' | 2. The signal value $IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$ = 1 (On) is receive |
...
| 26 | NR1L-VSM42-017 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$' | 1. Send the signal $IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$ = 1 (On) |
| 26 | NR1L-VSM42-017 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$' | 3. Send the signal $IPC_VEHICLE_SETUP2.EPB_MaintenanceMode$ = 0 (Off) |
