# PLAYBOOK — vsm_v42 (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_vsm_v42_Profile.md`
- Kickoff prompt (§5)
...
> 讀 `vsm_v42HMI/PLAYBOOK.md`、`vsm_v42HMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`vsm_v42HMI/feature.yaml`、
