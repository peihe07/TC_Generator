# PLAYBOOK — Time_Management (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_Time_Management_Profile.md`
- Kickoff prompt (§5)
...
7. On anything the sources don't state: `[ASSUMPTION A-TMnn]` marker +
...
> 讀 `Time_ManagementHMI/PLAYBOOK.md`、`Time_ManagementHMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`Time_ManagementHMI/feature.yaml`、
...
## 6. Status board — Time_Management
