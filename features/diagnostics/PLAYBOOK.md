# PLAYBOOK — Diagnostics (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_Diagnostics_Profile.md`
- Kickoff prompt (§5)
...
7. On anything the sources don't state: `[ASSUMPTION A-DIAGnn]` marker +
...
> 讀 `DiagnosticsHMI/PLAYBOOK.md`、`DiagnosticsHMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`DiagnosticsHMI/feature.yaml`、
