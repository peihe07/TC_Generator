...
| `Cover 封面` 之作者欄 | **留空（Pei 裁定 2026-08-26，逐字「Cover 封面 不處理 空著就好」）** | 母體 17 檔實測：**11 空／6 非空**，非空者為兩個他人姓名，**無一為本 feature 之作者**；「依慣例填」之前提不成立。**其留空與母本現況、與語料多數（11/17）三者一致** —— **此為裁定之結果，非遺漏，亦非未決** |
