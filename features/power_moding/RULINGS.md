...
**沿革（同日補記）**：本條之教訓已上收至 canon —— `§4.3.1` 增列
「下半一律英文」「下半含中文 = FAIL，不得出貨」，並釐清其與
`[OVERRIDE-R5]`（BT／Projection 雙語豁免）之界線：該豁免係就上半之
verbatim 而言，不及於下半。自此他 feature **直接依 canon §4.3.1**，
不再需引本條；本條退為該 canon 條文之來由記載。
