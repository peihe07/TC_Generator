...
**合計 10 筆。** 其分布：`DR-PMH5` 2 筆（#1／#7）、`DR-PMH7` 4 筆（#1／#2／#6／#8）、`DR-PMH8` 4 筆（#1／#3／#4／#5）、**無所繫之 DR 2 筆（#9／#10）**——一筆得繫於多個問。
