...
## TC 1 — Lanse Sense Strenght 1 display updated on reception of LDW_Intensity message
...
(Lanse Sense Strenght 1 display updated on reception of LDW_Intensity message)
```

### pre_conditions

```
The menu item "Lanse Sense Strenght 1" is displayed and shows "Low"
```
...
```
1. Send the signal $IPC_VEHICLE_SETUP2.LDW_Intensity$ = 2 (High)
2. Read the menu item "Lanse Sense Strenght 1" and check that it shows "High"
```

### expected_result

```
1. The signal $IPC_VEHICLE_SETUP2.LDW_Intensity$ = 2 (High) is registered without a bus error
2. The menu item "Lanse Sense Strenght 1" shows "High"
```
