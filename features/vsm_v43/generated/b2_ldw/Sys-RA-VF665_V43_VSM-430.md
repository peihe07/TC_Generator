...
> IF "Half_HMI_Setting" PROXI parameter is equal to "Leve 3" THEN TLM shall display the " Lanse Sense Strenght 1 " menu item and the user can perform setting with the following options: Low, High
...
## TC 1 — Lanse Sense Strenght 1 menu offers 2 options at half level 3
...
(Lanse Sense Strenght 1 menu offers 2 options at half level 3)
```
...
2. Read the menu list and check that "Lanse Sense Strenght 1" is present
3. Read the options offered by "Lanse Sense Strenght 1" and check that they are "Low", "High"
```
...
2. The menu item "Lanse Sense Strenght 1" is displayed in the menu list
3. The menu item "Lanse Sense Strenght 1" offers exactly the options "Low", "High"
```

- specification_reference：`Vehicle_Setup_Management_by_VP-LTM_R1L_TBM_VF665_V43_R4_1.11.1.1.4
Sys-RA-VF665_V43_VSM-430`
- design_method：決策表 (Decision Table Testing)｜priority：P1｜split_flag：False｜distinguishing_axis：Half_HMI_Setting = Leve 3
