...
## TC 1 — Lanse Sense Strenght 1 request sent for low selection
...
(Lanse Sense Strenght 1 request sent for low selection)
```
...
```
1. Select "Lanse Sense Strenght 1" = "Low" on the TLM display
...
```
1. The menu item "Lanse Sense Strenght 1" shows "Low"
...
Sys-RA-VF665_V43_VSM-431`
- design_method：邊界值分析 (Boundary Value Analysis, BVA)｜priority：P1｜split_flag：False｜distinguishing_axis：Strenght 1 option = Low
