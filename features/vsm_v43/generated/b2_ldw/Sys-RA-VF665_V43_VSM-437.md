...
## TC 1 — Lanse Sense Strenght 2 request sent for high selection
...
(Lanse Sense Strenght 2 request sent for high selection)
```
...
```
1. Select "Lanse Sense Strenght 2" = "High" on the TLM display
...
```
1. The menu item "Lanse Sense Strenght 2" shows "High"
...
Sys-RA-VF665_V43_VSM-437`
- design_method：邊界值分析 (Boundary Value Analysis, BVA)｜priority：P1｜split_flag：False｜distinguishing_axis：Strenght 2 option = High
