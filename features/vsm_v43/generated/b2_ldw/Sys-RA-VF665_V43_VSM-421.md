...
## TC 1 — Lanse Sense Warning 1 request sent for early selection
...
(Lanse Sense Warning 1 request sent for early selection)
```
...
```
1. Select "Lanse Sense Warning 1" = "Early" on the TLM display
...
```
1. The menu item "Lanse Sense Warning 1" shows "Early"
...
Sys-RA-VF665_V43_VSM-421`
- design_method：邊界值分析 (Boundary Value Analysis, BVA)｜priority：P1｜split_flag：False｜distinguishing_axis：Warning 1 option = Early
