...
## TC 1 — Lanse Sense Warning 2 display updated on reception of LDW_Sensibility message
...
(Lanse Sense Warning 2 display updated on reception of LDW_Sensibility message)
```

### pre_conditions

```
The menu item "Lanse Sense Warning 2" is displayed and shows "Early"
```
...
```
1. Send the signal $IPC_VEHICLE_SETUP2.LDW_Sensibility$ = 1 (Med)
2. Read the menu item "Lanse Sense Warning 2" and check that it shows "Med"
```

### expected_result

```
1. The signal $IPC_VEHICLE_SETUP2.LDW_Sensibility$ = 1 (Med) is registered without a bus error
2. The menu item "Lanse Sense Warning 2" shows "Med"
```
