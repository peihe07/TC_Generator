...
> IF "Half_Torque_Sensibility" PROXI parameter is equal to "Leve 3" THEN TLM shall display the " Lanse Sense Warning 1 " menu item and the user can perform setting with the following options: Early, Late
...
## TC 1 — Lanse Sense Warning 1 menu offers 2 options at half level 3
...
(Lanse Sense Warning 1 menu offers 2 options at half level 3)
```
...
2. Read the menu list and check that "Lanse Sense Warning 1" is present
3. Read the options offered by "Lanse Sense Warning 1" and check that they are "Early", "Late"
```
...
2. The menu item "Lanse Sense Warning 1" is displayed in the menu list
3. The menu item "Lanse Sense Warning 1" offers exactly the options "Early", "Late"
```

- specification_reference：`Vehicle_Setup_Management_by_VP-LTM_R1L_TBM_VF665_V43_R4_1.11.1.1.3
Sys-RA-VF665_V43_VSM-420`
- design_method：決策表 (Decision Table Testing)｜priority：P1｜split_flag：False｜distinguishing_axis：Half_Torque_Sensibility = Leve 3
