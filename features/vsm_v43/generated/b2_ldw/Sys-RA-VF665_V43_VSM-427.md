...
## TC 1 — Lanse Sense Warning 2 request sent for late selection
...
(Lanse Sense Warning 2 request sent for late selection)
```
...
```
1. Select "Lanse Sense Warning 2" = "Late" on the TLM display
...
```
1. The menu item "Lanse Sense Warning 2" shows "Late"
...
Sys-RA-VF665_V43_VSM-427`
- design_method：邊界值分析 (Boundary Value Analysis, BVA)｜priority：P1｜split_flag：False｜distinguishing_axis：Warning 2 option = Late
