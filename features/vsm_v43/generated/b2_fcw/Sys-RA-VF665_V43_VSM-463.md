...
## TC 1 — FCW Setting2 request sent for audio brake selection
...
(FCW Setting2 request sent for audio brake selection)
```
...
```
1. Select "Forward Collision Warning Setting2" = "Audio_Brake" on the TLM display
...
```
1. The menu item "Forward Collision Warning Setting2" shows "Audio_Brake"
...
Sys-RA-VF665_V43_VSM-463`
- design_method：等價劃分 (Equivalence Partitioning, EP)｜priority：P1｜split_flag：False｜distinguishing_axis：Setting2 option = Audio_Brake
