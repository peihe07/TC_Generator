...
## TC 1 — FCW Setting1 request sent for off selection
...
(FCW Setting1 request sent for off selection)
```
...
```
1. Select "Forward Collision Warning Setting1" = "Off" on the TLM display
...
```
1. The menu item "Forward Collision Warning Setting1" shows "Off"
...
Sys-RA-VF665_V43_VSM-456`
- design_method：等價劃分 (Equivalence Partitioning, EP)｜priority：P1｜split_flag：False｜distinguishing_axis：Setting1 option = Off
