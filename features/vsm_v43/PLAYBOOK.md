# PLAYBOOK — vsm_v43 (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_vsm_v43_Profile.md`
- Kickoff prompt (§5)
...
7. On anything the sources don't state: `[ASSUMPTION A-VSnn]` marker +
...
> 讀 `vsm_v43HMI/PLAYBOOK.md`、`vsm_v43HMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`vsm_v43HMI/feature.yaml`、
