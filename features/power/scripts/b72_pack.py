"""72 包 §H 第 2 步 —— `sandbox/b72/pm_72.xlsx` ＋ `data/reviewed_287_72.md`。
...
OUTDIR = FEATURE / "sandbox/b72"
OUT = OUTDIR / "pm_72.xlsx"
MD = FEATURE / "data/reviewed_287_72.md"
...
def main() -> None:
    ...
    md = ["# 站④ 目視包 —— 全 287 條（72 包 / R-P397(a)）", "",
          ...
          f"> 工作簿：`features/power/sandbox/b72/pm_72.xlsx`"
