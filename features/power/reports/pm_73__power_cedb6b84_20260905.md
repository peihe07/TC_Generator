# lint036 報告：pm_73.xlsx

- 來源：`features/power/delivered/pm_73.xlsx`（唯讀）
- 資料列數：287
...
| M | 空欄三態 | 0 | 0 | 每列每欄 | 已校準 |
| N | 行尾多餘句號 | 0 | 0 | 每行 | 已校準 |
| P | 訊號寫法不合 R-1 v2 | 317 | 145 | 每次命中 | 已校準（SWC 0708：195 —— proc 11／er 184，見上繳 09） |
...
| 120 | NR1L-PowerManagement-119 | proc | 含 CJK 字元 | Timeout_Setting.Req 之設定方法 ⏎ 2. Apply ENTER_FULL_OPERATION ⏎ 3. Send the signal $STAT |
| 121 | NR1L-PowerManagement-120 | proc | 含 CJK 字元 | Timeout_Setting.Req 之設定方法 ⏎ 2. Apply ENTER_FULL_OPERATION ⏎ 3. Send the signal $STAT |
...
| 11 | NR1L-PowerManagement-262 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 4 (Full_Operation) i |
...
| 18 | NR1L-PowerManagement-268 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$PARK_INFO.ChimeActivation_LHF$' | 1. Send the signal $PARK_INFO.ChimeActivation_LHF$ = 1 (Active) and check that t |
...
| 21 | NR1L-PowerManagement-271 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 1. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
| 21 | NR1L-PowerManagement-271 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
...
| 21 | NR1L-PowerManagement-271 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 4. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 29 | NR1L-PowerManagement-281 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 6 (Bench) is receive |
...
| 39 | NR1L-PowerManagement-049 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 3. Send the signal $STATUS_BH_BCM1.OperationalModeSts$ = 4 (Ignition_On) (DR-PW2 |
...
| 45 | NR1L-PowerManagement-055 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$PARK_INFO.ChimeActivation_LHF$' | 4. Send the signal $PARK_INFO.ChimeActivation_LHF$ = 1 (Active) and check that t |
| 45 | NR1L-PowerManagement-055 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 7 (Partial_Operation |
...
| 47 | NR1L-PowerManagement-057 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 1. Send the signal $STATUS_BH_BCM1.OperationalModeSts$ = 2 (Ignition_Off) |
| 47 | NR1L-PowerManagement-057 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM2.RemStActvSts$' | 2. Send the signal $STATUS_BH_BCM2.RemStActvSts$ = 0 (Remote Start Not Active) |
...
| 47 | NR1L-PowerManagement-057 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 1. The signal value $STATUS_BH_BCM1.OperationalModeSts$ = 2 (Ignition_Off) is re |
| 47 | NR1L-PowerManagement-057 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM2.RemStActvSts$' | 2. The signal value $STATUS_BH_BCM2.RemStActvSts$ = 0 (Remote Start Not Active)  |
| 47 | NR1L-PowerManagement-057 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 51 | NR1L-PowerManagement-061 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.DriverDoorSts$' | 1. Send the signal $STATUS_BH_BCM1.DriverDoorSts$ = 1 (Open) and send the signal |
| 51 | NR1L-PowerManagement-061 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 1. Send the signal $STATUS_BH_BCM1.DriverDoorSts$ = 1 (Open) and send the signal |
...
| 55 | NR1L-PowerManagement-065 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 1. Send the signal $STATUS_BH_BCM1.OperationalModeSts$ = 10 (Ignition_Pre_Off) |
| 55 | NR1L-PowerManagement-065 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM2.RemStActvSts$' | 2. Send the signal $STATUS_BH_BCM2.RemStActvSts$ = 0 (Remote Start Not Active) |
...
| 55 | NR1L-PowerManagement-065 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 1. The signal value $STATUS_BH_BCM1.OperationalModeSts$ = 10 (Ignition_Pre_Off)  |
| 55 | NR1L-PowerManagement-065 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM2.RemStActvSts$' | 2. The signal value $STATUS_BH_BCM2.RemStActvSts$ = 0 (Remote Start Not Active)  |
| 55 | NR1L-PowerManagement-065 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 83 | NR1L-PowerManagement-093 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.DriverDoorSts$' | 1. Send the signal $STATUS_BH_BCM1.DriverDoorSts$ = 1 (Open) |
...
| 85 | NR1L-PowerManagement-095 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.DriverDoorSts$' | 1. Send the signal $STATUS_BH_BCM1.DriverDoorSts$ = 1 (Open) |
...
| 90 | NR1L-PowerManagement-100 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
| 90 | NR1L-PowerManagement-100 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
| 90 | NR1L-PowerManagement-100 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 4. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
| 90 | NR1L-PowerManagement-100 | proc | PROXI 行形態不合 R-G70 v4.1 之標準式亦非既知舊式 | 3. Hold for the PROXI Switch_Off_Time value |
| 90 | NR1L-PowerManagement-100 | er | PROXI 行形態不合 R-G70 v4.1 之標準式亦非既知舊式 | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
| 90 | NR1L-PowerManagement-100 | er | PROXI 行形態不合 R-G70 v4.1 之標準式亦非既知舊式 | 4. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 91 | NR1L-PowerManagement-101 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
| 91 | NR1L-PowerManagement-101 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
| 91 | NR1L-PowerManagement-101 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 4. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
| 91 | NR1L-PowerManagement-101 | proc | PROXI 行形態不合 R-G70 v4.1 之標準式亦非既知舊式 | 3. Hold for the PROXI Switch_Off_Time value |
| 91 | NR1L-PowerManagement-101 | er | PROXI 行形態不合 R-G70 v4.1 之標準式亦非既知舊式 | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
| 91 | NR1L-PowerManagement-101 | er | PROXI 行形態不合 R-G70 v4.1 之標準式亦非既知舊式 | 4. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 93 | NR1L-PowerManagement-103 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
| 93 | NR1L-PowerManagement-103 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 93 | NR1L-PowerManagement-103 | er | PROXI 行形態不合 R-G70 v4.1 之標準式亦非既知舊式 | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 94 | NR1L-PowerManagement-104 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
| 94 | NR1L-PowerManagement-104 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
| 94 | NR1L-PowerManagement-104 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$BCM_FD_27.Comfort_Enable_Time$' | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 106 | NR1L-PowerManagement-116 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM2.RemStActvSts$' | 1. Send the signal $STATUS_BH_BCM2.RemStActvSts$ = 1 (Remote Start Active) |
...
| 106 | NR1L-PowerManagement-116 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM2.RemStActvSts$' | 1. The signal value $STATUS_BH_BCM2.RemStActvSts$ = 1 (Remote Start Active) is r |
| 106 | NR1L-PowerManagement-116 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 7 (Partial_Operation |
...
| 107 | NR1L-PowerManagement-117 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 111 | NR1L-PowerManagement-035 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 113 | NR1L-PowerManagement-037 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 116 | NR1L-PowerManagement-040 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 119 | NR1L-PowerManagement-118 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 4. Send the signal $STATUS_BH_BCM1.OperationalModeSts$ = 15 (SNA) (DR-PW26) |
...
| 120 | NR1L-PowerManagement-119 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 3. Send the signal $STATUS_BH_BCM1.OperationalModeSts$ = 2 (Ignition_Off) (DR-PW |
...
| 120 | NR1L-PowerManagement-119 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 3. The signal value $STATUS_BH_BCM1.OperationalModeSts$ = 2 (Ignition_Off) is re |
| 120 | NR1L-PowerManagement-119 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 4. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
| 120 | NR1L-PowerManagement-119 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 6. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 121 | NR1L-PowerManagement-120 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 3. Send the signal $STATUS_BH_BCM1.OperationalModeSts$ = 2 (Ignition_Off) (DR-PW |
...
| 121 | NR1L-PowerManagement-120 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM1.OperationalModeSts$' | 3. The signal value $STATUS_BH_BCM1.OperationalModeSts$ = 2 (Ignition_Off) is re |
| 121 | NR1L-PowerManagement-120 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 4. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
| 121 | NR1L-PowerManagement-120 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 6. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 124 | NR1L-PowerManagement-123 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 170 | NR1L-PowerManagement-027 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 7. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
...
| 174 | NR1L-PowerManagement-031 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 3. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 2 (Timed) is receive |
...
| 192 | NR1L-PowerManagement-011 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_LIN.PN14_LS_Actv$' | 1. Send the signal $STATUS_LIN.PN14_LS_Actv$ = 1 (Active) |
| 192 | NR1L-PowerManagement-011 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_LIN.PN14_LS_Lvl7$' | 2. Send the signal $STATUS_LIN.PN14_LS_Lvl7$ = 1 (Active) |
| 193 | NR1L-PowerManagement-012 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_LIN.Batt_ST_Crit$' | 1. Send the signal $STATUS_LIN.Batt_ST_Crit$ = 1 (True) |
...
| 201 | NR1L-PowerManagement-169 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 6. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 204 | NR1L-PowerManagement-284 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 6. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 205 | NR1L-PowerManagement-285 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$BCM_FD_27.Comfort_Enable_Act$' | 4. Send the signal $BCM_FD_27.Comfort_Enable_Act$ = 0 (DR-PW26) |
...
| 205 | NR1L-PowerManagement-285 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 5. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 1 (Standby) is recei |
...
| 243 | NR1L-PowerManagement-179 | proc | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM2.CmdIgnSts$' | 1. Send the signal $STATUS_BH_BCM2.CmdIgnSts$ = 5 (START) during the animation ( |
...
| 243 | NR1L-PowerManagement-179 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_BH_BCM2.CmdIgnSts$' | 1. The signal value $STATUS_BH_BCM2.CmdIgnSts$ = 5 (START) is received during th |
...
| 273 | NR1L-PowerManagement-202 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$STATUS_TELEMATIC.PowerSts_Telematic$' | 2. The signal value $STATUS_TELEMATIC.PowerSts_Telematic$ = 3 (Idle) is received |
| 273 | NR1L-PowerManagement-202 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_FD_5.CM_TCH_STAT$' | 4. The signal value $TELEMATIC_FD_5.CM_TCH_STAT$ = 1 (TCH_PSD) is received toget |
| 273 | NR1L-PowerManagement-202 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_FD_5.CM_TCH_X_COORD$' | 4. The signal value $TELEMATIC_FD_5.CM_TCH_STAT$ = 1 (TCH_PSD) is received toget |
| 273 | NR1L-PowerManagement-202 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_FD_5.CM_TCH_Y_COORD$' | 4. The signal value $TELEMATIC_FD_5.CM_TCH_STAT$ = 1 (TCH_PSD) is received toget |
| 273 | NR1L-PowerManagement-202 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_FD_5.CM_TCH_STAT$' | 5. The signal value $TELEMATIC_FD_5.CM_TCH_STAT$ = 1 (TCH_PSD) is received toget |
| 273 | NR1L-PowerManagement-202 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_FD_5.CM_TCH_X_COORD$' | 5. The signal value $TELEMATIC_FD_5.CM_TCH_STAT$ = 1 (TCH_PSD) is received toget |
| 273 | NR1L-PowerManagement-202 | er | v3 記法殘留（R-G70(h)：`$` 包覆式已撤銷）'$TELEMATIC_FD_5.CM_TCH_Y_COORD$' | 5. The signal value $TELEMATIC_FD_5.CM_TCH_STAT$ = 1 (TCH_PSD) is received toget |
