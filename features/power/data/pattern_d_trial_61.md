...
> ✅ **已採（63 包 R-P376(b)）**：`-057` 與 `-065`（同錨點 `CFTS009-4941504`）
> 依本檔之寫法入 corpus。R-P376(a) 之三要件並立者限「因果同錨點段落」，
> **丁案不全推**；其餘 12 條維持 PENDING。
> R-P376(d)：該二條**不覆蓋 `RemStartFail` 內部值本身**，代價入交付說明。
