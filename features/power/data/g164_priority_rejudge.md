...
> 受檢範圍：全部 **P0 193 條** ＋ Branding and Theme 全 **34** 條，去重後 **183** 條 / 264。
...
| `063` | 3_power_state_a | P0 | （無） | **無 P0 類別命中，亦非裝飾性** | **提案人工裁決** |
| `064` | 3_power_state_a | P0 | boot / recovery（開機與復原） → `Standby` | P0 成立 | P0 |
| `065` | 3_power_state_a | P0 | （無） | **無 P0 類別命中，亦非裝飾性** | **提案人工裁決** |
...
| `095` | 3_power_state_a | P0 | （無） | **無 P0 類別命中，亦非裝飾性** | **提案人工裁決** |
