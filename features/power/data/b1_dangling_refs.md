...
| 4 | 009 | §1.3.3.5 | Power up Sequence | `4941243` | 否 | — | `（無法解析檔名）` |
...
| 12 | 009 | §1.9.1 | Loss of Communication Behavior | `4941852` | 否 | — | `（無法解析檔名）` |
...
| 17 | 010 | §1.1 | Revision Notes | `4942194` | 否 | — | `（無法解析檔名）` |
| 18 | 010 | §1.4.1.1 | Voltage Level Behavior | `4942204` | 否 | — | `（無法解析檔名）` |
| 19 | 010 | §1.5.2.2.1.1 | System Voltage | `4942307` | 否 | — | `（無法解析檔名）` |
| 20 | 010 | §1.5.2.2.1.1 | System Voltage | `4942308` | 否 | — | `（無法解析檔名）` |
| 21 | 010 | §1.5.2.2.1.2 | ECU Local Voltage | `4942310` | 否 | — | `（無法解析檔名）` |
| 22 | 010 | §1.5.2.2.1.2 | ECU Local Voltage | `4942311` | 否 | — | `（無法解析檔名）` |
| 23 | 010 | §1.5.3.2.1.1 | System Voltage | `4942319` | 否 | — | `（無法解析檔名）` |
| 24 | 010 | §1.5.3.2.1.1 | System Voltage | `4942320` | 否 | — | `（無法解析檔名）` |
| 25 | 010 | §1.5.3.2.1.1 | System Voltage | `4942321` | 否 | — | `（無法解析檔名）` |
| 26 | 010 | §1.5.3.2.1.2 | ECU Local Voltage | `4942324` | 否 | — | `（無法解析檔名）` |
| 27 | 010 | §1.5.3.2.1.2 | ECU Local Voltage | `4942325` | 否 | — | `（無法解析檔名）` |
| 28 | 010 | §1.8.2.1.1 | System Voltage | `4942360` | 否 | — | `（無法解析檔名）` |
| 29 | 010 | §1.8.2.1.1 | System Voltage | `4942361` | 否 | — | `（無法解析檔名）` |
| 30 | 010 | §1.8.2.1.2 | ECU Local Voltage | `4942363` | 否 | — | `（無法解析檔名）` |
| 31 | 010 | §1.8.2.1.2 | ECU Local Voltage | `4942364` | 否 | — | `（無法解析檔名）` |
