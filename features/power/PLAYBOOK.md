# PLAYBOOK — Power (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_Power_Profile.md`
- Kickoff prompt (§5)
...
> 讀 `PowerHMI/PLAYBOOK.md`、`PowerHMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`PowerHMI/feature.yaml`、
