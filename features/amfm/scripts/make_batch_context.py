...
Usage:
    python features/amfm/scripts/make_batch_context.py --feature-dir features/amfm --list
    python features/amfm/scripts/make_batch_context.py --feature-dir features/amfm \\
        --batch "Tuner Availability"
    python features/amfm/scripts/make_batch_context.py --feature-dir features/amfm --pilot
"""
