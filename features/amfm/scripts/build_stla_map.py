...
Usage:
    python features/amfm/scripts/build_stla_map.py --feature-dir features/amfm
    python features/amfm/scripts/build_stla_map.py --feature-dir features/amfm --check-batches
"""
