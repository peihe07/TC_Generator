...
Usage:
    python features/amfm/scripts/extract_exemplars.py --feature-dir features/amfm
    python features/amfm/scripts/extract_exemplars.py --feature-dir features/amfm --per-group 3
"""
