...
Usage:
    python features/amfm/scripts/lint_tcs.py --feature-dir features/amfm
    python features/amfm/scripts/lint_tcs.py --feature-dir features/amfm --json-report lint_report.json
"""
