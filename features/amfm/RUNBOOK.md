...
> they were written.
>
> **2026-08-11: directory moved `AMFM` → `features/amfm`.** Repo-wide
> reorganisation — all features now live under `features/`, lowercase and
> without the HMI suffix. Unlike the 2026-08-10 rename, the commands and path
> pointers in the body below are NOT rewritten: they are dated records of runs
