# PLAYBOOK — Phone (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_Phone_Profile.md`
- Kickoff prompt (§5)
...
7. On anything the sources don't state: `[ASSUMPTION A-PHnn]` marker +
...
> 讀 `PhoneHMI/PLAYBOOK.md`、`PhoneHMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`PhoneHMI/feature.yaml`、
