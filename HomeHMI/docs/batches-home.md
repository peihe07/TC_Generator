...
|---|---|---|---|---|
| B1 | CarPlay Template | 5 | 020, 021, 032, 033, 034 | PDF p.8 HSD5.6/5.7/8.4-8.6; Pop Up List PU1291 |
...
| B7 | Last Mode | 15 | 076, 077, 078, 079, 080, 081, 082, 083, 084, 085, 086, 087, 088, 089, 090 | Last Mode Table `R1 SR24 1A (August 2 2021).xlsx` List Item 1/35/64/155/180-182/208-210/236/261/279/308/331; A-H03 |
...
- B7 正常生成(A-H03 已裁定同一份文件)。context 來自 Last Mode Table 分頁,不注入 Home Screen 規格文字——`_{n}` 是 List Item 編號,與 Home outline 編號撞名
- B7 的 spec_reference 用實際檔名 `Last Mode Table HMI Logic and Flow R1 SR24 1A (August 2 2021)_{n}`,刻意不同於 037 的 `R1L-R` 標籤
