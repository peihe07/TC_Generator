# lint036 報告：diagnostics_v05.xlsx

- 來源：`features/diagnostics/sandbox/merged/diagnostics_v05.xlsx`（唯讀）
- 資料列數：357
...
| 列 | TC ID | 欄位 | 說明 | 片段 |
| ---: | --- | --- | --- | --- |
| 354 | NR1L-DIAG-345 | test_item | 上半 52 tokens > 50 | If retries are performed as shown on the flowchart, and the retries are the resu |
| 355 | NR1L-DIAG-346 | test_item | 上半 52 tokens > 50 | If retries are performed as shown on the flowchart, and the retries are the resu |
| 356 | NR1L-DIAG-347 | test_item | 上半 52 tokens > 50 | If retries are performed as shown on the flowchart, and the retries are the resu |
| 357 | NR1L-DIAG-348 | test_item | 上半 52 tokens > 50 | If retries are performed as shown on the flowchart, and the retries are the resu |
| 363 | NR1L-DIAG-354 | test_item | 上半 52 tokens > 50 | If retries are performed as shown on the flowchart, and the retries are the resu |
| 364 | NR1L-DIAG-355 | test_item | 上半 52 tokens > 50 | If retries are performed as shown on the flowchart, and the retries are the resu |
| 365 | NR1L-DIAG-356 | test_item | 上半 52 tokens > 50 | If retries are performed as shown on the flowchart, and the retries are the resu |
| 366 | NR1L-DIAG-357 | test_item | 上半 52 tokens > 50 | If retries are performed as shown on the flowchart, and the retries are the resu |
