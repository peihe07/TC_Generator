# lint036 報告：diagnostics_batch3_v06.xlsx

- 來源：`features/diagnostics/sandbox/batch3/diagnostics_batch3_v06.xlsx`（唯讀）
- 資料列數：105
...
| 列 | TC ID | 欄位 | 說明 | 片段 |
| ---: | --- | --- | --- | --- |
| 106 | NR1L-DIAG-229 | proc | R-DIAG32：描述行指名之服務為 2E，而其下位元組行之 SID 為 2F | Send a write request for DID $5100 with the last b |
| 107 | NR1L-DIAG-230 | proc | R-DIAG32：描述行指名之服務為 2E，而其下位元組行之 SID 為 2F | Send a write request for DID $5100 with a paramete |
