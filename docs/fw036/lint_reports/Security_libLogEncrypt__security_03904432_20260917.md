# lint036 報告：FM-WI-FSM-036-A01 STLA 測試用例規範與結果_SWQT STLA Test Case Specification & Result_SWQT_Security_libLogEncrypt_20260917.xlsx

- 來源：`features/security/sandbox/delivery/FM-WI-FSM-036-A01 STLA 測試用例規範與結果_SWQT STLA Test Case Specification & Result_SWQT_Security_libLogEncrypt_20260917.xlsx`（唯讀）
- 資料列數：12
