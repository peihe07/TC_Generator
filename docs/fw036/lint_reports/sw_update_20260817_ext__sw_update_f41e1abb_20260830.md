...
| M | 空欄三態 | 0 | 0 | 每列每欄 | 已校準 |
| N | 行尾多餘句號 | 0 | 0 | 每行 | 已校準 |
| P | 訊號寫法不合 R-1 v3 | 16 | 4 | 每次命中 | 未校準（R-1 v3，21 包改寫；profile 專屬） |
...
**總計：行計 72**（列計不加總——同一列可觸發多項檢查）

## 明細

### P — 訊號寫法不合 R-1 v3（行計 16／列計 4）

| 列 | TC ID | 欄位 | 說明 | 片段 |
| ---: | --- | --- | --- | --- |
| 14 | newR1L-SU-275 | pre | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Status$ = "No' | 4. PENDING: DR-SU2 means of setting $FOTA_MASTER.FOTA_Status$ = "No FOTA Event"  |
| 14 | newR1L-SU-275 | proc | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Status$ = "No' | 1. PENDING: DR-SU2 step to set $FOTA_MASTER.FOTA_Status$ = "No FOTA Event" |
| 14 | newR1L-SU-275 | proc | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Status$ = "No' | 3. PENDING: DR-SU2 check that the head unit shows no forced update HMI while $FO |
| 14 | newR1L-SU-275 | er | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Status$ = "No' | 1. PENDING: DR-SU2 observable evidence that $FOTA_MASTER.FOTA_Status$ = "No FOTA |
| 15 | newR1L-SU-276 | pre | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Cancellation_Reason$ = a' | 4. PENDING: DR-SU2 means of setting $FOTA_MASTER.FOTA_Cancellation_Reason$ = a c |
| 15 | newR1L-SU-276 | proc | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Cancellation_Reason$ = a' | 1. PENDING: DR-SU2 step to set $FOTA_MASTER.FOTA_Cancellation_Reason$ = a cancel |
| 15 | newR1L-SU-276 | proc | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Cancellation_Reason$ = a' | 3. PENDING: DR-SU2 check that the head unit displays the stored cancellation rea |
| 15 | newR1L-SU-276 | er | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Cancellation_Reason$ = a' | 1. PENDING: DR-SU2 observable evidence that $FOTA_MASTER.FOTA_Cancellation_Reaso |
| 16 | newR1L-SU-277 | pre | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.Delay_Prohibited$ = [Prohibited]' | 4. PENDING: DR-SU2 means of setting $FOTA_MASTER.Delay_Prohibited$ = [Prohibited |
| 16 | newR1L-SU-277 | proc | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.Delay_Prohibited$ = [Prohibited]' | 1. PENDING: DR-SU2 step to set $FOTA_MASTER.Delay_Prohibited$ = [Prohibited] |
| 16 | newR1L-SU-277 | proc | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.Delay_Prohibited$ = [Prohibited]' | 3. PENDING: DR-SU2 check that the head unit offers no delay option and requires  |
| 16 | newR1L-SU-277 | er | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.Delay_Prohibited$ = [Prohibited]' | 1. PENDING: DR-SU2 observable evidence that $FOTA_MASTER.Delay_Prohibited$ = [Pr |
| 19 | newR1L-SU-280 | pre | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Status$ = "Waiting' | 4. PENDING: DR-SU2 means of setting $FOTA_MASTER.FOTA_Status$ = "Waiting for HMI |
| 19 | newR1L-SU-280 | proc | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Status$ = "Waiting' | 1. PENDING: DR-SU2 step to set $FOTA_MASTER.FOTA_Status$ = "Waiting for HMI Acce |
| 19 | newR1L-SU-280 | proc | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Status$ = "Waiting' | 3. PENDING: DR-SU2 check that the head unit prompts the user to accept, delay or |
| 19 | newR1L-SU-280 | er | 賦值缺 DBC `VAL_` 標籤 `(<label>)`（R-1 v3(a)／R-7）：'$FOTA_MASTER.FOTA_Status$ = "Waiting' | 1. PENDING: DR-SU2 observable evidence that $FOTA_MASTER.FOTA_Status$ = "Waiting |
...
| 14 | newR1L-SU-275 | pre | PENDING 佔位（DR-SU2） | 4. PENDING: DR-SU2 means of setting $FOTA_MASTER.FOTA_Status$ = "No FOTA Event"  |
| 14 | newR1L-SU-275 | proc | PENDING 佔位（DR-SU2） | 1. PENDING: DR-SU2 step to set $FOTA_MASTER.FOTA_Status$ = "No FOTA Event" |
| 14 | newR1L-SU-275 | proc | PENDING 佔位（DR-SU2） | 3. PENDING: DR-SU2 check that the head unit shows no forced update HMI while $FO |
| 14 | newR1L-SU-275 | er | PENDING 佔位（DR-SU2） | 1. PENDING: DR-SU2 observable evidence that $FOTA_MASTER.FOTA_Status$ = "No FOTA |
| 14 | newR1L-SU-275 | er | PENDING 佔位（DR-SU2） | 3. PENDING: DR-SU2 observable evidence that the head unit shows no forced update |
| 15 | newR1L-SU-276 | pre | PENDING 佔位（DR-SU2） | 4. PENDING: DR-SU2 means of setting $FOTA_MASTER.FOTA_Cancellation_Reason$ = a c |
| 15 | newR1L-SU-276 | proc | PENDING 佔位（DR-SU2） | 1. PENDING: DR-SU2 step to set $FOTA_MASTER.FOTA_Cancellation_Reason$ = a cancel |
...
| 16 | newR1L-SU-277 | pre | PENDING 佔位（DR-SU2） | 4. PENDING: DR-SU2 means of setting $FOTA_MASTER.Delay_Prohibited$ = [Prohibited |
| 16 | newR1L-SU-277 | proc | PENDING 佔位（DR-SU2） | 1. PENDING: DR-SU2 step to set $FOTA_MASTER.Delay_Prohibited$ = [Prohibited] |
| 16 | newR1L-SU-277 | proc | PENDING 佔位（DR-SU2） | 3. PENDING: DR-SU2 check that the head unit offers no delay option and requires  |
| 16 | newR1L-SU-277 | er | PENDING 佔位（DR-SU2） | 1. PENDING: DR-SU2 observable evidence that $FOTA_MASTER.Delay_Prohibited$ = [Pr |
...
| 19 | newR1L-SU-280 | pre | PENDING 佔位（DR-SU2） | 4. PENDING: DR-SU2 means of setting $FOTA_MASTER.FOTA_Status$ = "Waiting for HMI |
| 19 | newR1L-SU-280 | proc | PENDING 佔位（DR-SU2） | 1. PENDING: DR-SU2 step to set $FOTA_MASTER.FOTA_Status$ = "Waiting for HMI Acce |
| 19 | newR1L-SU-280 | proc | PENDING 佔位（DR-SU2） | 3. PENDING: DR-SU2 check that the head unit prompts the user to accept, delay or |
| 19 | newR1L-SU-280 | er | PENDING 佔位（DR-SU2） | 1. PENDING: DR-SU2 observable evidence that $FOTA_MASTER.FOTA_Status$ = "Waiting |
