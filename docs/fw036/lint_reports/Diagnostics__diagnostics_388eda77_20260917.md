# lint036 報告：FM-WI-FSM-036-A01 STLA 測試用例規範與結果_SWQT STLA Test Case Specification & Result_SWQT_Diagnostics_20260917.xlsx

- 來源：`features/diagnostics/sandbox/delivery/FM-WI-FSM-036-A01 STLA 測試用例規範與結果_SWQT STLA Test Case Specification & Result_SWQT_Diagnostics_20260917.xlsx`（唯讀）
- 資料列數：556
...
| 357 | NR1L-DIAG-348 | er | PENDING 佔位（DR-DIAG-1） | 1. PENDING: DR-DIAG-1 NRC value for an unsuccessful Sirius XM package ID applica |
