# PLAYBOOK — {FEATURE} (FW036 TC Generation)
...
- Profile: `docs/runtime/profiles/FW036_R1L_{FEATURE}_Profile.md`
- Kickoff prompt (§5)
...
7. On anything the sources don't state: `[ASSUMPTION A-{abbr}nn]` marker +
...
> 讀 `{FEATURE}HMI/PLAYBOOK.md`、`{FEATURE}HMI/RUNBOOK.md`、
> `docs/fw036/FEATURE_ONBOARDING.md`、`{FEATURE}HMI/feature.yaml`、
